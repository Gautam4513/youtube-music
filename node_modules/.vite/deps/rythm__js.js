...
var require_rythm = __commonJS({
  "node_modules/rythm.js/rythm.js"(exports, module) {
    (function(global, factory) {
      ...
      var Analyser = function Analyser2() {
        var _this = this;
        classCallCheck(this, Analyser2);
      ...
      var Player = function Player2(forceAudioContext) {
        var _this = this;
      ...
      var reset = function reset2(elem) {
      ...
      var shake = function(elem, value) {
        ...
        var twist2 = (max - min) * value;
        elem.style.transform = "translate3d(" + (min + twist2) + "px, 0, 0)";
      };
      var reset$1 = function reset2(elem) {
        elem.style.transform = "";
      };
      var jump = function(elem, value) {
        ...
        var jump2 = (max - min) * value;
        elem.style.transform = "translate3d(0, " + -jump2 + "px, 0)";
      };
      var reset$2 = function reset2(elem) {
        elem.style.transform = "";
      };
      var twist = function(elem, value) {
        ...
        var twist2 = (max - min) * value;
        elem.style.transform = "rotate(" + (min + twist2) + "deg) translateZ(0)";
      };
      var reset$3 = function reset2(elem) {
        elem.style.transform = "";
      };
      var vanish = function(elem, value) {
        ...
        var min = !isNaN(options.min) ? options.min : 0;
        var vanish2 = (max - min) * value;
        if (options.reverse) {
          elem.style.opacity = max - vanish2;
        } else {
          elem.style.opacity = min + vanish2;
        }
      };
      var reset$4 = function reset2(elem) {
        elem.style.opacity = "";
      };
      ...
      var reset$5 = function reset2(elem) {
      ...
      var reset$6 = function reset2(elem) {
      ...
      var reset$7 = function reset2(elem) {
      ...
      var blur = function(elem, value) {
        ...
        var min = !isNaN(options.min) ? options.min : 0;
        var blur2 = (max - min) * value;
        if (options.reverse) {
          blur2 = max - blur2;
        } else {
          blur2 = min + blur2;
        }
        elem.style.filter = "blur(" + blur2 + "px)";
      };
      var reset$8 = function reset2(elem) {
        elem.style.filter = "";
      };
      var coefficientMap = {
        up: -1,
      ...
      var swing = function(elem, value) {
        var options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
        var radius2 = !isNaN(options.radius) ? options.radius : 20;
        ...
        var _ref = [coefficientMap[direction], coefficientMap[curve]], xCoefficient = _ref[0], yCoefficient = _ref[1];
        elem.style.transform = "translate3d(" + xCoefficient * radius2 * Math.cos(value * Math.PI) + "px, " + yCoefficient * radius2 * Math.sin(value * Math.PI) + "px, 0)";
      };
      var reset$9 = function reset2(elem) {
        elem.style.transform = "";
      };
      ...
      var reset$10 = function reset2(elem) {
      ...
      var kern = function(elem, value) {
        ...
        var max = !isNaN(options.max) ? options.max : 25;
        var min = !isNaN(options.min) ? options.min : 0;
        var kern2 = (max - min) * value;
        if (options.reverse) {
          kern2 = max - kern2;
        } else {
          kern2 = min + kern2;
        }
        elem.style.letterSpacing = kern2 + "px";
      };
      var reset$11 = function reset2(elem) {
      ...
      var fontSize = function(elem, value) {
        ...
        var fontSize2 = (max - min) * value + min;
        elem.style.fontSize = fontSize2 + "em";
      };
      var reset$12 = function reset2(elem) {
      ...
      var borderWidth = function(elem, value) {
        ...
        var min = !isNaN(options.min) ? options.min : 0;
        var borderWidth2 = (max - min) * value + min;
        elem.style.borderWidth = borderWidth2 + "px";
      };
      var reset$13 = function reset2(elem) {
      ...
      var reset$14 = function reset2(elem) {
        elem.style.transform = "";
      };
      ...
      var reset$15 = function reset2(elem) {
        elem.style.color = "";
      };
      var Dancer = function() {
        function Dancer2() {
          classCallCheck(this, Dancer2);
          this.resets = {};
          this.dances = {};
        ...
        createClass(Dancer2, [
          {
            ...
            value: function registerDance(type, dance) {
              var reset$$1 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : function() {
              };
          ...
          },
          {
            ...
            value: function dance(type, className, ratio, options) {
              ...
              if (typeof type === "string") {
                dance2 = this.dances[type] || this.dances["pulse"];
              } else {
                dance2 = type.dance;
              }
              var elements = document.getElementsByClassName(className);
              Array.from(elements).forEach(function(elem) {
                return dance2(elem, ratio, options);
              });
            }
          },
          {
            ...
            value: function reset$$1(type, className) {
              var reset$$12 = type;
              if (typeof type === "string") {
                reset$$12 = this.resets[type] || this.resets["pulse"];
              } else {
                reset$$12 = type.reset;
              }
              var elements = document.getElementsByClassName(className);
              Array.from(elements).forEach(function(elem) {
                return reset$$12(elem);
              });
            }
          }
        ]);
      ...
      var Rythm$1 = function Rythm(forceAudioContext) {
        ...
        this.renderRythm = function() {
          ...
          _this.rythms.forEach(function(mappingItem) {
            var type = mappingItem.type, elementClass = mappingItem.elementClass, nbValue = mappingItem.nbValue, startValue = mappingItem.startValue, options = mappingItem.options;
            _this.dancer.dance(
              type,
              elementClass,
...
export default require_rythm();
//# sourceMappingURL=rythm__js.js.map
